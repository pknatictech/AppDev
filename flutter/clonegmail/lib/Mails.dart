              ...
              SizedBox(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Sent ₹160 to PUSHPENDRA KUMAR",
                      style:
                          TextStyle(fontSize: 13, fontWeight: FontWeight.bold),
                    ),
                    Text(
                      "PhonePe Oct 22,2023 Paid To PUSHPEND...",
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                   Text("9:15 am",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13),),
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: ListView(
          children: [
            printinngmail(),
            printinngmailbyvalue("P", "PK", "Payment", "This is mail")
          ],
        ),
      ),
    );
